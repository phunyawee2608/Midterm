...
<head>
    ...
    <title>2.4 สร้างรูปแบบตัวเลขสามเหลี่ยม - Green Theme</title>
...
<div class="main-card">
    <div class="form-section">
        <h2>2.4 สร้างรูปแบบตัวเลขสามเหลี่ยม</h2>
        ...
        <div class="btn-group">
            <button class="btn-render" onclick="drawTriangle()">แสดงรูปแบบ</button>
...
<script>
    function drawTriangle() {
        ...
        if (n > 50) {
            alert("เพื่อความสวยงาม กรุณากรอกไม่เกิน 50 แถวครับ");
            return;
        }

        let output = "";
        
        // Logic: Nested Loop สร้างสามเหลี่ยม
        for (let i = 1; i <= n; i++) {
            let row = "";
            for (let j = 1; j <= i; j++) {
                row += j + " ";
